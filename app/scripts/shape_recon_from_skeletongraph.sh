...
inputfolder="/media/wlsdzyzl/DATA/datasets/20250108_radius/"
outputfolder="/media/wlsdzyzl/DATA/datasets/20250108_radius/recon"
...
for file in $files; do
  ...
  $cpp_program "$file" "$output_file" "0.005" "-1" "1"
  end_time=$(date +%s.%N)
